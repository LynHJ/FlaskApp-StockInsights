...
If you would like to keep your eye on this stock, simply click the <button>Add To My List</button>. This saves the searched stock in your “My List” menu. It is saved there for future reference, containing the price of when it was added, as well as the date.
About us
So who are we? StockInsights was created by three budding data analysts with a background in finance and a keen interest in the movements of the markets.
